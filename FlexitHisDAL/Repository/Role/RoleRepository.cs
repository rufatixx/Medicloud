...
namespace Medicloud.DAL.Repository.Role
{
	public class RoleRepository : IRoleRepository
	{
		...
		public async Task<List<RoleDAO>> GetUserRoles(int organizationId, int userId)
		{
			...
			var result = await con.QueryAsync<RoleDAO>(sqlQuery, new { OrganizationId = organizationId, UserId = userId });
